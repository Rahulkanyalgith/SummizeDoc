    ...
    <div className="flex gap-4 mb-4 justify-between">
      <div className="space-y-6">
        <div className=" flex flex-wrap items-center gap-4">
          ...
          >
            <Sparkles className="h-4 w-4 min-w-[16px] min-h-[16px] mr-1 text-purple-500" />
            AI Summary
          </Badge>
      ...
      <div className="self-start">
        <Link href={`/dashboard`}>
          <Button
            variant={"link"}
            size="sm"
            className="group flex items-center gap-1 sm:gap-2 hover:bg-white/80 backdrop-blur-xs rounded-full transition-all duration-200 shadow-xs hover:shadow-md border border-purple-100/30 bg-purple-100 px-2 sm:px-3"
          >
            <ChevronLeft
