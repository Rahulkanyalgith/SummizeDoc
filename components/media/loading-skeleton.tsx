...
export default function LoadingSkeleton() {
  return (
    <Card className="relative px-2 h-[700px] w-[600px] max-w-lg mx-auto overflow-hidden bg-gradient-to-br from-background via-background/95 to-purple-500/5 backdrop-blur-lg shadow-2xl rounded-3xl border border-purple-500/10">
        ...
        <div className="px-4 flex gap-1.5">
          {[1, 2, 3].map((_, index) => (
            ...
            >
              <div
                className={cn(
                  "h-full bg-gradient-to-r from-gray-500 to-purple-600 animate-pulse",
                  index === 0 ? "w-full" : "w-0",
                )}
              />
            </div>
            ...
            {[1, 2].map((_, index) => (
              ...
              >
                <div className="relative flex items-center gap-3">
                  ...
                  <div className="h-6 w-full bg-purple-500/10"></div>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4 bg-background/80 backdrop-blur-xs border-t border-purple-500/10">
        <div className="flex justify-between items-center">
          <Skeleton className="rounded-full w-12 h-12 bg-gradient-to-br from-purple-500/50 to-indigo-600/50 " />
