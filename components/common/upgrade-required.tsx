...
export default function UpgradeRequired() {
  return (
    <div className="relative min-h-[50vh]">
      <BgGradient className="from-purple-400 via-purple-300 to-indigo-200" />
      <div className="container px-8 py-16">
        <div className="flex flex-col items-center justify-center gap-8 text-center max-w-2xl mx-auto">
          ...
          <p className="text-lg leading-8 text-gray-600 border-2 border-purple-200 bg-white/50 backdrop-blur-xs rounded-lg p-6 border-dashed max-w-xl">
